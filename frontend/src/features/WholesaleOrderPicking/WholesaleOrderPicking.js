...
const WholesaleOrderPicking = () => {
    ...
    const startResize = (column) => (e) => {
      ...
      if (column === 'checkbox' || !columnWidths[column].isResizable) return;
      e.preventDefault();
  ...
  export default WholesaleOrderPicking;

/*
    This structure separates the common layout elements (Sidebar, TopBar) into a Layout component, which wraps around
    the feature-specific content. The WholesaleOrderPicking component now only contains the content specific to that feature.
    To implement the PlaceOrder feature, you would create a new component in features/PlaceOrder/PlaceOrder.js and add
    its route in App.js. This approach allows you to maintain a consistent layout across all features while keeping the
    feature-specific code separate and focused.
*/